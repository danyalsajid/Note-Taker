		...
		>
			<div class="modal-body">
				<div class="text-center mb-4">
					<i class="fas fa-exclamation-triangle" style={{ "font-size": "3rem", "color": "#dc2626", "margin-bottom": "1rem" }} />
				...
				{props.note && (
					<div class="alert alert-danger border-danger mb-4">
						<div class="d-flex align-items-start mb-3">
							<i class="fas fa-sticky-note me-3 mt-1" style={{ "color": "#dc2626", "font-size": "1.25rem" }} />
