								...
								{(note) => (
									...
									>
										<div class="d-flex align-items-start">
											<i class="fas fa-sticky-note text-primary me-3 mt-1" style={{ "font-size": "0.875rem" }} />
											<div class="flex-grow-1 min-w-0">
												...
												<div class="text-muted small d-flex align-items-center">
													<i class="fas fa-sitemap me-1" style={{ "font-size": "0.75rem" }} />
													<span class="text-truncate">{note.hierarchy}</span>
												</div>
												<div class="text-muted small mt-1">
													<i class="fas fa-calendar me-1" style={{ "font-size": "0.75rem" }} />
