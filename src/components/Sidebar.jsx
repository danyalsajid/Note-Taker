				...
				<div class="d-flex align-items-center justify-content-between">
					...
					>
						<span class="me-2" style={{ "font-size":"1rem" }}>
							{type === "organisation" &&  <i class='fas fa-hospital' style={{ color: "#bf5b52" }} />}
							{type === "team" && <i class='fas fa-users' style={{ color: "#57ade6" }} />}
							{type === "client" && <i class='fas fa-user' style={{ color: "#2471a3" }} />}
							{type === "episode" && <i class='fas fa-clipboard-list' style={{ color: "#c9c697" }} />}
						</span>
